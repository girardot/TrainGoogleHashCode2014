...
public class ReaderTest {
    ...
    public void should_read_file() {
        ...
        assertThat(grid.getCell(1, 2).getColorTarget()).isEqualTo(COLORED);
        assertThat(grid.getCell(1, 3).getColorTarget()).isEqualTo(COLORED);
        assertThat(grid.getCell(1, 4).getColorTarget()).isEqualTo(COLORED);
        assertThat(grid.getCell(2, 2).getColorTarget()).isEqualTo(COLORED);
        assertThat(grid.getCell(2, 4).getColorTarget()).isEqualTo(COLORED);
        assertThat(grid.getCell(3, 2).getColorTarget()).isEqualTo(COLORED);
        assertThat(grid.getCell(3, 3).getColorTarget()).isEqualTo(COLORED);
        assertThat(grid.getCell(3, 4).getColorTarget()).isEqualTo(COLORED);
        assertThat(grid.getCell(4, 2).getColorTarget()).isEqualTo(COLORED);
    }
